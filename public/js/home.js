...
strokeWeight(0.127*scale);
	...
	image(img1,startX+.2*scale,startY+ 3.7*scale, 30, 30);
	...
	image(img2,startX+3.5*scale,startY+.2*scale, 25, 25);
	...
	image(img1,startX+1+(4.34)*scale,startY+ 1.869*scale, 30, 30);
